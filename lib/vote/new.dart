...
class VoteNewState extends State<VoteNew> {
  ...
  void onNext() async {
    ...
    if (s.validate()) {
      ...
      const seed = "destroy public fog slim about evolve traffic chef moment genius curtain spell genius mimic gravity around spot plug genre soldier warm basic anchor toddler";
      const lwd = "https://zec.rocks";
      try {
