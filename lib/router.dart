...
// import 'pages/vote/delegate.dart';
// import 'pages/vote/overview.dart';
// import 'pages/vote/vote.dart';
      ...
      branches: [
        StatefulShellBranch(
          ...
          routes: [
            GoRoute(
              path: '/account',
              builder: (context, state) => SizedBox.shrink(), // HomePage(),
        ...
        StatefulShellBranch(
          routes: [
            GoRoute(
                path: '/more',
                builder: (context, state) => SizedBox.shrink(), // MorePage(),
                routes: [
                  // GoRoute(
                  //     path: 'account_manager',
                  //     builder: (context, state) => AccountManagerPage(main: true),
                  //     routes: [
                  //       GoRoute(
                  //           path: 'new',
